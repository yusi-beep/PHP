...
<!--Поръчка на продукт------------------------------------------------------------------------------------------------------------------------>
		...
		<div id="productblock1">
			<div id="prodname">
			<h2 class="name" style="text-align:left">Храна за кучета Darling - Цена:<font color="red" style="text-align:right">9,99</font>лв</h2>
			</div>
			<div id="view">
				<img id="photo2" src="photos/darling10kg.jpg">
				<div id="miniview">
				<img id="lentapic" src="photos/darling10kg.jpg">
				<img id="lentapic" src="photos/darling10kg.jpg">
				<img id="lentapic" src="photos/darling10kg.jpg">
				</div>			
			</div>
