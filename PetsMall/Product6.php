...
<!--Поръчка на продукт------------------------------------------------------------------------------------------------------------------------>
		...
		<div id="productblock1">
			<div id="prodname">
			<h2 class="name" style="text-align:left">Керамична купичка Черна- Цена:<font color="red" style="text-align:right">19,99</font>лв</h2>
			</div>
			<div id="view">
				<img id="photo2" src="photos/ceramicCupbl.jpeg">
				<div id="miniview">
				<img id="lentapic" src="photos/ceramicCupbl.jpeg">
				<img id="lentapic" src="photos/ceramicCupbl.jpeg">
				<img id="lentapic" src="photos/ceramicCupbl.jpeg">
				</div>			
			</div>
