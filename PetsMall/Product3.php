...
<!--Поръчка на продукт------------------------------------------------------------------------------------------------------------------------>
		...
		<div id="productblock1">
			<div id="prodname">
			<h2 class="name" style="text-align:left">Керамична купичка Розова- Цена:<font color="red" style="text-align:right">19,99</font>лв</h2>
			</div>
			<div id="view">
				<img id="photo2" src="photos/ceramiccup.jpg">
				<div id="miniview">
				<img id="lentapic" src="photos/ceramiccup.jpg">
				<img id="lentapic" src="photos/ceramiccup.jpg">
				<img id="lentapic" src="photos/ceramiccup.jpg">
				</div>			
			</div>
