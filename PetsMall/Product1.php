...
<!--Поръчка на продукт------------------------------------------------------------------------------------------------------------------------>
		...
		<div id="productblock1">
			<div id="prodname">
			<h2 class="name" style="text-align:left">Купичка за вода - Цена:<font color="red" style="text-align:right">15,99</font>лв</h2>
			</div>
			<div id="view">
				<img id="photo2" src="photos/watercup1.jpg">
				<div id="miniview">
				<img id="lentapic" src="photos/watercup.jpg">
				<img id="lentapic" src="photos/watercup2.jpg">
				<img id="lentapic" src="photos/watercup3.jpg">
				</div>			
			</div>
			<div id="blockform">
				<?php
